...
//put required title
  _fetchData = () =>{
    ...
    api.createProjects(this.refs.title.getValue(), this.refs.deadline.value, this.refs.description.getValue(), localStorage.token)
    .then (res => {
  ...
  render(){
    return (
      <div className="createNewProject">
          ...
          <DatePicker hintText="Deadline" mode="landscape" ref="deadline" onChange={e => this._handleChange(e)} value={this.state.date}/>
